...
func PasskeyRegisterBegin(c *gin.Context) {
	...
	flowToken, expiresAt, err := passkeysvc.CreateSessionDataFlow(
		...
		passkeysvc.FlowSecurity{AuthSessionIdentity: identity.SessionIdentity(), Scope: authorization.Scope, ContextHash: authorization.ContextHash, Authorization: authorization},
		sessionData,
	)
	if err != nil {
		writeSecurityOperationError(c, err)
...
func PasskeyRegisterFinish(c *gin.Context) {
	...
	if err := model.RegisterPasskeyForSession(identity.SessionIdentity(), passkeyCredential); err != nil {
		writeSecurityOperationError(c, err)
		return
	}
...
func PasskeyDelete(c *gin.Context) {
	...
	if err := model.DeletePasskeyForSession(identity.SessionIdentity()); err != nil {
		writeSecurityOperationError(c, err)
		return
	}
...
func PasskeyVerifyBegin(c *gin.Context) {
	...
	flowToken, expiresAt, err := passkeysvc.CreateSessionDataFlow(
		...
		passkeysvc.FlowSecurity{AuthSessionIdentity: identity.SessionIdentity(), Scope: binding.Scope, ContextHash: binding.ContextHash},
		sessionData,
	)
	if err != nil {
		writeSecurityOperationError(c, err)
