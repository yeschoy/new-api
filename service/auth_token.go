...
// SessionIdentity omits the transport-only login method from transaction guards.
func (identity AuthIdentity) SessionIdentity() model.AuthSessionIdentity {
	return model.AuthSessionIdentity{
