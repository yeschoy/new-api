...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	if relayInfo.PriceData.CacheCreationRatioConfigured {
		other.SetPublic("cache_creation_ratio", relayInfo.PriceData.CacheCreationRatio)
	}
...
func GenerateClaudeOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	// Declared rates, including zero, remain visible when this request used no cache.
