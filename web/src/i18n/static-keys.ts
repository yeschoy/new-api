...
export const STATIC_I18N_KEYS = [
  ...
  'Usage guide',
  'Chat and writing',
  'Office and local files',
  'Write code',
  'Translate pages',
  'Knowledge bases and workflows',
  'Switch accounts and configs',
  'Mainland line',
  'Global line',
  'This site',
  'Direct OpenAI-compatible support',
  'Needs a config file or has limits',
  'Needs a special protocol',
  'Cannot set a custom Base URL',
  'Console',
  'Model Square',
  'Rankings',
  'Docs',
