...
export const STATIC_I18N_KEYS = [
  ...
  // Referral cashback dynamic risk and audit labels
  'new_account',
  'rapid_registration_to_topup',
  ...
  'device_invalid',
  'login_ip_mismatch',
  'first_observed_ip_mismatch',
  'shared_ip_accounts',
  'shared_device_accounts',
  'device_rotation',
  'user_agent_changed',
  'high_topup_frequency',
  'high_topup_failure_rate',
  'repeated_amount',
  'small_test_then_large',
  'reward_near_single_limit',
  'high_daily_reward_exposure',
  'reward_capped',
  'inviter_concentration',
  'prior_payment_incident',
  'open_debt',
  'single_cap',
  'daily_cap',
  'daily_cap_exhausted',
  'below_minimum',
  'beneficiary_has_open_cashback_debt',
  'no_payable_cashback_quota',
  'cashback_record_incomplete',
  'topup_not_successful',
  'order_relationship_mismatch',
  'ineligible_completion_source',
  'payment_incident_recorded',
  'self_referral',
  'referral_account_missing',
  'referral_account_disabled',
  'referral_relationship_changed',
  'provider_callback',
  'verified_return',
  'admin_manual',
  'Payment incident: {{kind}}',
  'missing',
  'invalid',
  'valid',
  'refund',
  ...
  'Attempted cashback reward review',
