...
import { YecaiMetric, YecaiPanel, type YecaiTone } from '@/components/yecai'
      ...
      >
        ...
        <div className='dopa-dev-signal-grid'>
          {heroSignals.map((signal) => {
            const Icon = signal.icon
            let tone: YecaiTone = 'model'
            if (signal.tone === 'info') tone = 'signal'
            if (signal.tone === 'success') tone = 'leaf'
