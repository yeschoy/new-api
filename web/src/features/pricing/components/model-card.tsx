...
export const ModelCard = memo(function ModelCard(props: ModelCardProps) {
  ...
  return (
    <Card
      role='article'
      className='hover:ring-foreground/20 h-full min-w-0 cursor-pointer gap-3 transition-colors'
      onClick={props.onClick}
    >
      <header className='flex flex-row items-start gap-3 px-4'>
        <div
          aria-hidden
      ...
      <CardContent className='flex flex-1 flex-col gap-3'>
        ...
        <div data-slot='model-metadata' className='mt-auto flex flex-col gap-3'>
          <div
            role='group'
      ...
      <footer className='border-border/60 mx-4 mt-auto flex flex-wrap items-center justify-between gap-3 border-t py-2'>
        {(isTokenBased || props.perf) && <ModelPerfBadge perf={props.perf} />}
